...
submitBtn.MouseButton1Click:Connect(function()
    if keyInput.Text == "alturahubkey2025" then
        ...
        local modes = {
            {Name = "Altura Hub MM2", Script = "https://raw.githubusercontent.com/DatUnknownGuy/Altura-Hub/refs/heads/main/Altura%20HubV1.6.lua"},
        ...
        discordButton.Text = "Copy Altura Hub Link"
        ...
        local nwScriptSideButton = Instance.new("TextButton")
        nwScriptSideButton.Size = UDim2.new(0, 300, 0, 45)
        nwScriptSideButton.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
        nwScriptSideButton.TextColor3 = Color3.fromRGB(255, 255, 255)
        nwScriptSideButton.Text = "Copy NW ScriptSide Link"
        nwScriptSideButton.Font = Enum.Font.GothamMedium
        nwScriptSideButton.TextSize = 20
        nwScriptSideButton.Parent = buttonFrame

        local nwScriptSideCorner = Instance.new("UICorner")
        nwScriptSideCorner.CornerRadius = UDim.new(0, 8)
        nwScriptSideCorner.Parent = nwScriptSideButton

        nwScriptSideButton.MouseEnter:Connect(function()
            nwScriptSideButton.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
        end)

        nwScriptSideButton.MouseLeave:Connect(function()
            nwScriptSideButton.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
        end)

        nwScriptSideButton.MouseButton1Click:Connect(function()
            local success, err = pcall(function()
                setclipboard("https://discord.gg/JmmPRfxjYH")
            end)
            if not success then
                warn("Failed to copy NW ScriptSide link: " .. tostring(err))
            end
        end)
    else
        keyInput.Text = ""
